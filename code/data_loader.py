...
class Dataset_traffic(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='1', scale=True, timeenc=0, freq='w', seasonal_patterns=None):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
...
class Dataset_pprice(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='M', data_path='pprice.csv',
                 target='OT', scale=True, timeenc=0, freq='w', seasonal_patterns=None):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
...
class Dataset_electricity(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='MT_000', scale=True, timeenc=0, freq='w', seasonal_patterns=None):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
